...
interface ModalBitacoraGrupoProps {
    idGrupo: string;
...
export default function ModalBitacoraGrupo({ idGrupo, Cerrar }: ModalBitacoraGrupoProps) {
    ...
    const Buscar = async () => {
        ...
        setListaBitacora([]);
        try {
            const response = await fetch(`${API_BASE_URL}/bitacoras/ObtenerBitacoraGrupo/${idGrupo}`, {
                method: 'GET',
                headers: {
        ...
        >
            <div className="w-full max-w-4xl rounded-2xl bg-white p-8 shadow-2xl transform transition-transform duration-300 border-2 border-blue-500 scale-100">
                <div className="flex items-center justify-between">
                    <h3 className="text-2xl font-bold text-gray-900">Bitacora de Grupo o cliente</h3>
